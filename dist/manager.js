...
export async function listFunkos(user) {
    ...
    try {
        ...
        const funkos = await Promise.all(// Leer todos los archivos y parsear su contenido, para ello se utiliza Promise.all que permite ejecutar múltiples promesas en paralelo
